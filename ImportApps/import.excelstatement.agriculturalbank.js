...
//
// @id = ch.banana.apps.import.csvstatement.agricultural
// @api = 1.0
// @pubdate = 2016-04-06
// @publisher = Banana.ch SA
// @description = Agricultural Bank of China农业银行
...
function exec(inData) {
	...
	//For debugging purpose we show the content
...
function defineConversionParam() {
	...
	convertionParam.headerLineStart = 1;
	convertionParam.dataLineStart = 2;
	...
	convertionParam.rowConverter = function (inputRow) {
		...
		convertedRow["Income"] = Banana.Converter.toInternalNumberFormat(inputRow["收入金额"], ".");
		convertedRow["Expenses"] = Banana.Converter.toInternalNumberFormat(inputRow["支出金额"], ".");
