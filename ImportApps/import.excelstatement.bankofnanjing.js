...
//
// @id = ch.banana.apps.import.excelstatement.bankofnanjing
// @api = 1.0
// @pubdate = 20176-11-07
// @publisher = Banana.ch SA
// @description = 南京银行BankOfNanjing
...
function defineConversionParam() {
   ...
   convertionParam.textDelim = '"';
	...
	convertionParam.headerLineStart = 2;
	convertionParam.dataLineStart = 3;
	...
	* - Number decimal separator must be "." and there should be no thousand separator */
	convertionParam.rowConverter = function(inputRow) {
		...
		*    Create this fields so that you can use-it in the postprocessing function */
		...
		var stringDate = String(inputRow["交易日期"]).substring(0,10);
		convertedRow["Date"] = Banana.Converter.toInternalDateFormat(stringDate, "yyyy-mm-dd");
		...
		*  we already have negative amounts in Betrag and don't need the to fill the column Expenses*/
		convertedRow["Income"] = Banana.Converter.toInternalNumberFormat(inputRow["借方发生额"], ".");
		convertedRow["Expenses"] = Banana.Converter.toInternalNumberFormat(inputRow["贷方发生额"], ".");
