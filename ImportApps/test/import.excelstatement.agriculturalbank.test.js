...
// @id = import.excelstatement.agriculturalbank.test
// @api = 1.0
// @pubdate = 2017-11-24
...
// @outputformat = none
// @inputdataform = none
// @includejs = ../import.excelstatement.agriculturalbank.js
// @timeout = -1
...
ImportExcelCsvPingabankTest.prototype.testImport = function () {
	...
	var file = Banana.IO.getLocalFile("file:script/testcases/AgriculturalBankOfChina农业银行.xls.csv")
