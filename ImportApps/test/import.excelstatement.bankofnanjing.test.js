...
// @id = import.excelstatement.bankofnanjing.test
// @api = 1.0
// @pubdate = 2017-11-24
...
// @outputformat = none
// @inputdataform = none
// @includejs = ../import.excelstatement.bankofnanjing.js
// @timeout = -1
...
ImportExcelCsvPingabankTest.prototype.testImport = function () {
	...
	var file = Banana.IO.getLocalFile("file:script/testcases/BankOfNanjing南京银行.xls.csv")
