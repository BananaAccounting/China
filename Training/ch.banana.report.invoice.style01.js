...
//
// @id = ch.banana.report.invoice.test.style06.js
// @api = 1.0
// @pubdate = 2016-05-06
// @publisher = Banana.ch SA
// @description = Style Personalized
// @description.cn = Style Personalized
// @task = report.invoice
...
function printInvoiceBase(jsonInvoice, repDocObj, repStyleObj, param) {
  ...
  ***********/
  if (param.print_header) {
	...
	if (invoiceObj.supplier_info.business_name)
      cell.addParagraph(invoiceObj.supplier_info.business_name.toUpperCase(), "logo left bold");
  ...
  ***************/
  ...
  if (param.print_isr && invoiceObj.document_info.currency == "CHF") {
    ...
    //repDocObj.addParagraph(rowNumber);
...
function setInvoiceTexts(language) {
  ...
  if (language == 'it')
  {
    ...
    texts.param_print_isr = 'Stampa PVR (1=true, 0=false)';
    texts.param_isr_account = 'Conto PVR';
    texts.param_isr_id = 'Numero di adesione PVR';
	texts.param_isr_on_new_page = 'Stampa polizza di versamento su pagina separata (1=true, 0=false)';
  ...
  else if (language == 'de')
  {
    ...
    texts.param_print_isr = 'PVR ausdrucken (1=true, 0=false)';
    texts.param_isr_account = 'ESR-Konto';
    texts.param_isr_id = 'ESR-Teilnehmernummer';
	texts.param_isr_on_new_page = 'ESR auf ein separates Blatt drucken (1=true, 0=false)';
  ...
  else if (language == 'fr')
  {
    ...
    texts.param_print_isr = 'Imprimer BVR (1=true, 0=false)';
    texts.param_isr_account = 'Compte BVR';
    texts.param_isr_id = 'Numéro d’adhérent BVR';
	texts.param_isr_on_new_page = 'Imprimer le bulletin sur une page séparée (1=true, 0=false)';
  ...
  else
  {
    ...
    texts.param_print_isr = 'Print ISR (1=true, 0=false)';
    texts.param_isr_account = 'Account ISR';
    texts.param_isr_id = 'ISR subscriber number';
	texts.param_isr_on_new_page = 'Print ISR on a new page (1=true, 0=false)';
